...
│
├── bash/
│   └── collector.sh          # Extracts Git data
│
├── rust-core/
│   ├── src/
│   │   └── main.rs           # Processing, deduplication, clustering
│   └── Cargo.toml
│
├── python-api/
│   ├── generate_md.py        # Markdown and AI summarization
│   └── venv/                 # Python virtual environment
│
├── data/
│   ├── changes.jsonl         # Raw collected data
│   ├── output.json           # Processed clusters
│   └── CHANGELOG.md          # Final output
│
├── generate_changelog.sh     # Automation script
│
└── README.md
Installation
Prerequisites
...
Collects Git data from the target repository
Converts raw data into structured JSON
Processes and clusters changes using Rust
Enhances summaries using AI or fallback logic
Generates a categorized markdown changelog
